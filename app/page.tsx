...
export default function GiebueComingSoon() {
  ...
  return (
    <main className="min-h-screen bg-white text-black antialiased overflow-hidden">
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-xl border-b border-black/10">
        <div className="max-w-7xl mx-auto px-6 md:px-10 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl md:text-3xl font-normal tracking-[-0.03em]">
              Giebue
            </span>
          </div>
      ...
      <section className="relative border-b border-black/10 bg-[radial-gradient(circle_at_top_left,rgba(0,0,0,0.03),transparent_40%)]">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-10 pt-28 md:pt-36 pb-28 md:pb-36">
          <div className="max-w-5xl">
            ...
            <h1 className="text-[2.8rem] md:text-[5rem] leading-[1] tracking-[-0.02em] font-normal max-w-6xl">
              The impenetrable privacy and encryption
            </h1>

            <div className="mt-12 max-w-2xl">
              <p className="text-xl leading-relaxed text-neutral-700">
                Giebue is being developed with a focus on privacy, encryption,
                and modern security standards.
              </p>
            </div>

            <div className="mt-16">
              <p className="text-3xl md:text-5xl font-normal tracking-[-0.03em] text-black">
                Coming Soon
              </p>
            </div>
          </div>
      ...
      <section id="overview" className="py-28 md:py-36">
        <div className="max-w-7xl mx-auto px-6 md:px-10 grid lg:grid-cols-2 gap-20 items-start">
          <div>
            ...
            <h2 className="text-5xl md:text-6xl tracking-[-0.03em] leading-[1] font-normal max-w-xl">
          ...
          <div className="space-y-10 text-lg text-neutral-700 leading-relaxed">
            <p>
              Giebue is being developed around a modern architecture approach
              focused on long-term scalability and operational simplicity.
            </p>

            <p>
              The platform architecture prioritizes secure system design,
              efficient performance, and responsible handling of essential
              operational information.
            </p>

            <p>
              Public documentation and additional platform details will become
      ...
      <section
        id="principles"
        className="border-t border-black/10 bg-[#f6f4ef] py-28 md:py-36"
      >
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="max-w-3xl mb-20">
            ...
            <h2 className="text-5xl md:text-6xl tracking-[-0.03em] leading-[1] font-normal">
          ...
          <div className="grid md:grid-cols-3 gap-6 items-stretch">
            <div className="bg-white/90 backdrop-blur-sm border border-black/10 rounded-[1.5rem] p-8 shadow-[0_10px_30px_rgba(0,0,0,0.03)]">
              <h3 className="text-2xl font-normal tracking-tight mb-5">
                Privacy-first approach
              </h3>

              <p className="text-neutral-700 leading-relaxed text-lg">
                User information is intended to remain limited to operationally
                necessary data only.
              </p>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-sm border border-black/10 rounded-[1.5rem] p-8 shadow-[0_10px_30px_rgba(0,0,0,0.03)]">
              ...
              <p className="text-neutral-700 leading-relaxed text-lg">
                Platform systems are being structured around modern security and
            ...
            <div className="bg-white/90 backdrop-blur-sm border border-black/10 rounded-[1.5rem] p-8 shadow-[0_10px_30px_rgba(0,0,0,0.03)]">
              ...
              <p className="text-neutral-700 leading-relaxed text-lg">
                Architecture decisions are being designed for future
      ...
      <section
        id="security"
        className="py-28 md:py-36 border-t border-black/10"
      >
        <div className="max-w-7xl mx-auto px-6 md:px-10 grid lg:grid-cols-[0.9fr_1.1fr] gap-20">
          <div>
            ...
            <h2 className="text-5xl md:text-6xl tracking-[-0.03em] leading-[1] font-normal max-w-lg">
      ...
      <section className="border-t border-black/10 bg-black text-white">
        <div className="max-w-7xl mx-auto px-6 md:px-10 py-24 md:py-28">
          <div className="max-w-4xl">
            ...
            <h2 className="text-5xl md:text-7xl leading-[1] tracking-[-0.03em] font-normal mb-10">
              Built for privacy, reliability, and modern security.
            </h2>

            <p className="text-xl text-neutral-400 leading-relaxed max-w-2xl">
              Additional platform documentation and product information will be
              published progressively over time.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer
        id="contact"
        className="bg-black text-white border-t border-white/10 relative overflow-hidden"
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-10 py-14 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div>
            <h4 className="text-2xl font-normal tracking-tight mb-2">
              Giebue
            </h4>
          ...
          <div className="bg-white w-full max-w-5xl max-h-[90vh] overflow-y-auto rounded-[2rem] border border-black/10 p-8 md:p-12 relative">
            ...
            {activePage === "privacy" && (
              <div>
                ...
                <h2 className="text-4xl md:text-5xl tracking-[-0.03em] leading-[1] font-normal mb-12 max-w-3xl">
                  Privacy and responsible data handling remain central to the
                  development of Giebue.
                </h2>

                <div className="space-y-10 text-lg text-neutral-700 leading-relaxed">
                  <p>
                    Giebue is being developed with a focus on minimizing
                    unnecessary data collection and maintaining responsible
                    operational practices.
                  </p>

                  <p>
                    Only limited information required for essential
                    functionality, security, operational continuity, or legal
                    compliance may be processed where necessary.
                  </p>

                  <p>
                    Giebue is not designed around advertising networks,
                    third-party data resale, invasive profiling, or unnecessary
                    behavioral tracking practices.
                  </p>

                  <p>
                    Appropriate technical and organizational measures are
                    intended to be implemented to support platform security,
                    access control, and infrastructure protection.
                  </p>

                  <p>
                    Additional privacy documentation, platform policies, and
                    operational details may be updated periodically as the
                    platform evolves.
                  </p>

                  <p>Giebue is operated by Festung Holdings Pvt Ltd.</p>
                </div>
              </div>
            )}
            ...
            {activePage === "terms" && (
              <div>
                ...
                <h2 className="text-4xl md:text-5xl tracking-[-0.03em] leading-[1] font-normal mb-12 max-w-3xl">
                  Use of the platform will remain subject to applicable
                ...
                <div className="space-y-10 text-lg text-neutral-700 leading-relaxed">
                  <p>
                    ...
                    general informational purposes regarding the Giebue
                    platform.
                  </p>

                  <p>
                    Platform availability, functionality, features, and
                    documentation may change, expand, or evolve over time.
                  </p>

                  <p>
                    Unauthorized misuse, interference, disruption, or attempts
                    to compromise platform systems, infrastructure, or services
                    may result in access restrictions or legal action where
                    applicable.
                  </p>

                  <p>
                    Additional legal documentation, policies, and operational
                    guidelines may be published progressively as public platform
